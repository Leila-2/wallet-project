...
const StyledInput = styled.div`
	.label {
		...
		@media screen and ${baseTheme.media.desctopMin} and (min-height: 720px) {
			margin-bottom: 16px;
		}

		@media screen and ${baseTheme.media.desctopMin} and (min-height: 800px) {
			margin-bottom: 26px;
		}

		@media screen and ${baseTheme.media.desctopMin} and (min-height: 960px) {
			margin-bottom: 34px;
		}
	}
